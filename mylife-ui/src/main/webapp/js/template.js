  ...
  */
  ...
  //管理相册展示模板
    function manageAlbum() {
        ...
        +'			<span class="column__text">创建时间</span>'
        +'			<span class="column__text">最后修改时间</span>'
        +'          <span class="column__text"><b onclick="manageAlbum.updateAlbumBefor(<%:=list[i].albumId%>);">更改相册名字</b></span>'
        +'		</div>'
        +'		<div class="column column--right">'
        +'          <span class="column__text"><%:=list[i].albumName%></span>'
        +'			<span class="column__text"><%:=list[i].albumNum%></span>'
        +'			<span class="column__text"><%:=list[i].albumDate%></span>'
        +'			<span class="column__text"><%:=list[i].albumDateNew%></span>'
        +'          <span class="column__text"><b onclick="manageAlbum.deleteAlbumBefor(<%:=list[i].albumId%>);">删除相册</b></span>'
        +'		</div>'
        +'	</div>'
        +'</a>'
        +'<%}%>';
